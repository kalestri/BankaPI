...
public abstract class GenericForm extends JDialog{
	...
	public GenericForm(){
		...
		lblMode.setText("Režim pregleda/izmene");
		...
		add(bottomPanel, "dock south, grow");
