...
public class ValuteForm extends JDialog{
...
//		dataPanel.add(btnZoom);
	...
	private void initTable(){
		...
		DefaultTableModel tableModel = new DefaultTableModel(new String[] {"Sifra valute",   "Naziv", "Domicilna", "Drzavna valuta"
				, "Osnovna valuta", "Prema valuti", "Valuta racuna", "Analitika izvoda"}, 0);
