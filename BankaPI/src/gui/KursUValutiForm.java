...
public class KursUValutiForm extends JDialog{
	...
	private JTextField tfrbr = new JTextField(5);
	private JTextField tfSrednji = new JTextField(20);
	...
	private void initGui(){
		...
		JLabel lblSifra = new JLabel ("Redni br.");
		JLabel lblNaziv = new JLabel("Srednji:");

		dataPanel.add(lblSifra);
		dataPanel.add(tfrbr,"wrap, gapx 15px");
		dataPanel.add(lblNaziv);
		dataPanel.add(tfSrednji,"wrap,gapx 15px, span 3");
	...
	private void initTable(){
		...
		DefaultTableModel tableModel = new DefaultTableModel(new String[] {"Redni br.",   "Kupovni", "Srednji", "Prodajni", "valuteUListi", "osnovnaValuta", "premaValuti"}, 0);
...
//		} 
	...
	private void sync() {
		...
		String redniBroj = (String)tblGrid.getModel().getValueAt(index, 0);
		
		String srednji = (String)tblGrid.getModel().getValueAt(index, 2);
		
		tfrbr.setText(redniBroj);
		tfSrednji.setText(srednji);
