...
public class VrstePlacanjaForm extends JDialog{
	...
	private void initGui(){
		...
		JLabel lblSifra = new JLabel ("Oznaka vrste");
	...
	private void initTable(){
		...
		DefaultTableModel tableModel = new DefaultTableModel(new String[] {"Oznaka vrste",   "Naziv", "Analitika izvoda"}, 0);
...
//		} 
	...
	private void sync() {
		...
		String oznakaVrste = (String)tblGrid.getModel().getValueAt(index, 0);
		String nazivVrste = (String)tblGrid.getModel().getValueAt(index, 1);
		String analitikaIzvoda = (String)tblGrid.getModel().getValueAt(index, 2);
		
		tfSifra.setText(oznakaVrste);
		tfNaziv.setText(nazivVrste);
		tfSifraDrzave.setText(analitikaIzvoda);
