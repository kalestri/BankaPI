...
public class NaseljenoMestoForm extends JDialog{
	...
	private void initTable(){
		...
		DefaultTableModel tableModel = new DefaultTableModel(new String[] {"Šifra",   "Naziv", "PTT oznaka", "Mesto u drzavi", "Mesto prijema"}, 0);
...
//		} 
	...
	private void sync() {
		...
		String pttOznaka = (String)tblGrid.getModel().getValueAt(index, 2);
		String mestoUDrzavi = (String)tblGrid.getModel().getValueAt(index, 3);
		String mestoPrijema = (String)tblGrid.getModel().getValueAt(index, 4);

		tfSifra.setText(sifra);
		tfNaziv.setText(naziv);
		tfSifraDrzave.setText(pttOznaka);
		tfNazivDrzave.setText(mestoUDrzavi);
		tfNazivDrzave.setText(mestoPrijema);
	}
