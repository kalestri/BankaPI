...
public class DrzavaForm extends JDialog{
	...
	private void initGui(){
		...
		JLabel lblSifra = new JLabel ("Šifra drzave");
		JLabel lblNaziv = new JLabel("Naziv drzave");
	...
	private void initTable(){
		...
		DefaultTableModel tableModel = new DefaultTableModel(new String[] {"Šifra drzave",   "Naziv", "Valuta", "Naseljeno mesto"}, 0);
...
//		} 
	...
	private void sync() {
		...
		String nazivDrzave = (String)tblGrid.getModel().getValueAt(index, 1);
		
		tfSifra.setText(sifraDrzave);
		tfNaziv.setText(nazivDrzave);
