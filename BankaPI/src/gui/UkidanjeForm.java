...
public class UkidanjeForm extends JDialog{
	...
	private void initTable(){
		...
		DefaultTableModel tableModel = new DefaultTableModel(new String[] {"Id",   "Datum ukidanja", "Racun za prenos", "Ukidanje racuna"}, 0);
...
//		} 
	...
	private void sync() {
		...
		String id = (String)tblGrid.getModel().getValueAt(index, 0);
		String datumUkidanja = (String)tblGrid.getModel().getValueAt(index, 1);
		String racunZaPrenos = (String)tblGrid.getModel().getValueAt(index, 2);
		String ukidanjeRacuna = (String)tblGrid.getModel().getValueAt(index, 3);
